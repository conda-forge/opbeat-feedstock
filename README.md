About opbeat-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/opbeat-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/opbeat/opbeat_python

Documentation: https://opbeat.com/docs/topics/python/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5430&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/opbeat-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `opbeat` can be installed with `conda`:
...
```
mamba install opbeat
```

It is possible to list all of the versions of `opbeat` available on your platform with `conda`:
...
```
mamba search opbeat --channel conda-forge
```
...
mamba repoquery search opbeat --channel conda-forge

# List packages depending on `opbeat`:
mamba repoquery whoneeds opbeat --channel conda-forge

# List dependencies of `opbeat`:
mamba repoquery depends opbeat --channel conda-forge
```
